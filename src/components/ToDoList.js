...
import '../css/ToDoList.css'; // Presupunând că stilurile sunt salvate aici
                ...
                <table className="table text-white mb-0">
                  ...
                  <tbody>
                    <tr className="fw-normal">
                      ...
                      <td className="align-middle">
                        <button data-mdb-toggle="tooltip" title="Done"><i
                          className="fas fa-check fa-lg text-success me-3"></i></button>
                        <button data-mdb-toggle="tooltip" title="Remove"><i
                          className="fas fa-trash-alt fa-lg text-warning"></i></button>
                      </td>
                    </tr>
                    <tr className="fw-normal">
                      <th>
